...
About 1 in 4 rural Paranaenses lives in a município that ranks in the bottom quintile of composite access to health, education, and agricultural extension services. That is 73 municipalities and 338,499 rural residents.

I mapped every município of Paraná using an Enhanced 2-Step Floating Catchment Area over three federal datasets: 3,075 primary-care facilities from CNES, 1,187 rural schools from INEP, and 414 georeferenced IDR-Paraná extension offices from the official IDR unit shapefile.
